...
pipeline = Pipeline([
        ('features', FeatureUnion([
            ...
            ('glove', GloveVectorizer(glove_vecs))
        ])),
        ('clf', clf)])
...
parameters = {
    'features__tdidf__vect__analyzer': ['word'],
    'features__tdidf__vect__ngram_range': [(1, 1), (1, 2), (1, 3), (2, 3), (3, 3)],
    'features__tdidf__vect__stop_words': [None, 'english'],
    'features__tdidf__vect__max_features': (None, 50000),
    'features__tdidf__tfidf__use_idf': (True, False),
