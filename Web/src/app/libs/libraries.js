define('app/libs/libraries', [], function() {
  'use strict';
  return [{
    name: 'RequireJS',
    ...
    links: [{
      title: 'RequireJS Website',
      href: 'http://requirejs.org/',
      iconClass: 'fa-globe',
      linkText: 'Website'
    }, {
      title: 'Github Repository',
      href: 'http://github.com/jrburke/requirejs',
      iconClass: 'fa-github',
      linkText: 'Source Code'
    }, {
      title: 'Follow on Twitter',
      href: 'http://twitter.com/jrburke',
      iconClass: 'fa-twitter',
      linkText: 'Twitter'
    }, {
      title: 'Google Groups',
      href: 'http://groups.google.com/group/requirejs',
      iconClass: 'fa-google',
      linkText: 'Get Help'
    }]
  }, {
    ...
    name: 'Crossroads',
    description: ['Crossroads.js is a routing library inspired by URL Route/Dispatch utilities present on frameworks like Rails, Pyramid, Django, CakePHP, CodeIgniter, etc... It parses a string input and decides which action should be executed by matching the string against multiple patterns.', 'It is a powerful and flexible routing system. If used properly it can reduce code complexity by decoupling objects and also by abstracting navigation paths and server requests.'],
    links: [{
      title: 'Crossroads.js Website',
      href: 'http://millermedeiros.github.io/crossroads.js/',
      iconClass: 'fa-globe',
      linkText: 'Website'
    }, {
      title: 'Github Repository',
      href: 'http://github.com/millermedeiros/crossroads.js',
      iconClass: 'fa-github',
      linkText: 'Source Code'
    }]
  }, {
